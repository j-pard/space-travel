...
class MarsScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('bg2', './environment/bg-4.png');
        this.load.image('bg3', './environment/bg-4.png');
    }
    ...
    create(){
        ...
        //background
        bg1 = this.add.tileSprite(0 ,-5, this.cameras.main.width / 4, this.cameras.main.height / 4, "bg1");
        ...
        bg2 = this.add.tileSprite(0 ,-5, this.cameras.main.width / 4, this.cameras.main.height / 4, "bg2");
        ...
        bg3 = this.add.tileSprite(0 ,-5, this.cameras.main.width / 3, this.cameras.main.height / 3, "bg3");
