...
class MarsScene extends Phaser.Scene {
    ...
    preload(){
        preloadGame(this);
        //load map
        this.load.image("tiles", './img/tilesetMars.png');
        this.load.tilemapTiledJSON("map",'./map/mars.json');
        this.load.image('bg1', './environment/bg-4.png');
        this.load.image('bg2', './environment/bg-5.png');
        this.load.image('bg3', './environment/bg-6.png');
    ...
    create(){
        ...
        tset = MAP.addTilesetImage("Mars", "tiles");
